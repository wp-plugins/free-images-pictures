...
There is no requirement to obtain API key by `freeimages.pictures`. There is no custom configuration needed. If you wish to change settings you could provide so in plugins setting page.
...
1. Upload `free-images-pictures` to the `/wp-content/plugins/` directory
1. Activate the plugin through the 'Plugins' menu in WordPress
1. Go to manage post or page and there should be button for search free images next to the media library button
